...
accuracy_cross_score = cross_val_score(model, X, y, cv=10, scoring='accuracy') # array de 10 treinamentos diferentes

test_score = accuracy_score(y_test, y_preds) # valor de um treinamento
